...
evidence_sources:
  - GitCode: https://gitcode.com/openharmony/multimedia_av_codec/blob/master/services/media_engine/filters/decoder_surface_filter.cpp
    local: /home/west/av_codec_repo/services/media_engine/filters/decoder_surface_filter.cpp
  - GitCode: https://gitcode.com/openharmony/multimedia_av_codec/blob/master/services/media_engine/filters/surface_decoder_adapter.cpp
    local: /home/west/av_codec_repo/services/media_engine/filters/surface_decoder_adapter.cpp
  - GitCode: https://gitcode.com/openharmony/multimedia_av_codec/blob/master/services/services/codec/server/video/codec_server.cpp
    local: /home/west/av_codec_repo/services/services/codec/server/video/codec_server.cpp
---
...
> **GitCode**: https://gitcode.com/openharmony/multimedia_av_codec/blob/master/services/media_engine/filters/surface_decoder_adapter.cpp
> **本地**: `/home/west/av_codec_repo/services/media_engine/filters/surface_decoder_adapter.cpp`
...
> **GitCode**: https://gitcode.com/openharmony/multimedia_av_codec/blob/master/services/media_engine/filters/decoder_surface_filter.cpp
> **本地**: `/home/west/av_codec_repo/services/media_engine/filters/decoder_surface_filter.cpp`
> **行号锚点**: `SetVideoSurface` @ decoder_surface_filter.cpp:1368-1404
...
> **GitCode**: https://gitcode.com/openharmony/multimedia_av_codec/blob/master/services/services/codec/server/video/codec_server.cpp
> **本地**: `/home/west/av_codec_repo/services/services/codec/server/video/codec_server.cpp`
> **行号锚点**: `SetOutputSurface` @ codec_server.cpp:551-577 | `SetOutputSurfaceForPostProcessing` @ codec_server.cpp:1367-1371
...
**`SetOutputSurfaceForPostProcessing` 路由（后处理激活时）**：
> 源码：`services/services/codec/server/video/codec_server.cpp:1367-1371`

```cpp
int32_t CodecServer::SetOutputSurfaceForPostProcessing(sptr<Surface> surface)  // line 1367
{
    int32_t ret = postProcessing_->SetOutputSurface(surface);                   // line 1368
    CHECK_AND_RETURN_RET_LOG_WITH_TAG(ret == AVCS_ERR_OK, ret,                 // line 1369
        "Set output surface failed");                                            // line 1370
    return ret;                                                                  // line 1371
}                                                                                // line 1372
```
