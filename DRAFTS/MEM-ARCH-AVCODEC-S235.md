...
**E18** (audio_codec_worker.cpp L374-394): Pause/Resume——暂停恢复：Pause调用Dispose()并StopAsync线程，Resume重新调用Begin()恢复流水线；Dispose()原子设置isRunning=false并notify input/output条件变量
