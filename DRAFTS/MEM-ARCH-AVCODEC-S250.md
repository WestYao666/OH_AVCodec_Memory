...
```
来源: `interstitial_scheduler.h` (L55)
...
```
来源: `interstitial_scheduler.cpp` (L96-L115)
...
```
来源: `interstitial_strategies.h` (L28-L40)
...
```
来源: `interstitial_vod_strategies.cpp` (L40-L53)
...
```
来源: `interstitial_live_strategies.cpp` (L47-L63)
...
```
来源: `interstitial_controller.cpp` (L199-L210)
...
```
来源: `interstitial_controller.cpp` (DoSourceSwitch, L362 + L390)
