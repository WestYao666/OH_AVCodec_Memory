...
| 指标 | 数量 |
|------|------|
| **10_architecture/** | 230 个文件 |
| **20_dev_flow/** | 8 个文件 |
| **30_toolchain/** | 2 个文件 |
| **50_faq/** | 2 个文件 |
| **Memory 文件总计** | 230 个 |
| **已批准 (approved)** | 144 个 |
| **待审批 (pending_approval)** | 37 个 |
| **草稿 (draft)** | 3 个 |
| **待审批主题** | 0 个 |
...
- **本地变更**：0 个文件
- **待推送 Commit**：0 个
- **最新 Commit**：`5f68b85 state: S193 draft→pending_approval; add S216 S217 drafts; update pending_actions`
