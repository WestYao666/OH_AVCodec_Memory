...
| 指标 | 数量 |
|------|------|
| **10_architecture/** | 255 个文件 |
| **20_dev_flow/** | 8 个文件 |
| **30_toolchain/** | 2 个文件 |
| **50_faq/** | 2 个文件 |
| **Memory 文件总计** | 255 个 |
| **已批准 (approved)** | 144 个 |
| **待审批 (pending_approval)** | 50 个 |
| **草稿 (draft)** | 0 个 |
| **待审批主题** | 0 个 |
...
- **本地变更**：0 个文件
- **待推送 Commit**：1 个
- **最新 Commit**：`e2530dd S240: promote draft → pending_approval, 35 evidence, GitCode web_fetch verified`
